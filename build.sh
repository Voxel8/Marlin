...
case "$(uname -s)"
  ...
  ;; Linux)
    ...
    ARDUINO_EXEC_UPLOAD="/usr/share/arduino/hardware/tools/avrdude -C /usr/share/arduino/hardware/tools/avrdude.conf -U flash:w:firmware.hex:i -v -p atmega2560 -b 115200 -c stk500v2 $PORT -D"
  ;; CYGWIN*)
