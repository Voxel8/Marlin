...
static void _lcd_move(const char *name, AxisEnum axis, int min, int max) {
  if (encoderPosition != 0) {
    ...
    if (min_software_endstops_enabled[axis] && current_position[axis] < min) current_position[axis] = min;
    if (max_software_endstops_enabled[axis] && current_position[axis] > max) current_position[axis] = max;
    encoderPosition = 0;
