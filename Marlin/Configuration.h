...
#define STRING_URL "Voxel8 Gen3"
#define STRING_VERSION_CONFIG_H __DATE__ " " __TIME__ // build date and time
#define STRING_CONFIG_H_AUTHOR "hello@voxel8.co" // Who made the changes.
#define STRING_SPLASH_LINE1 STRING_VERSION " - " STRING_URL // will be shown during bootup in line 1
...
//it is highly recommended you let this Z_SAFE_HOMING enabled!!!
  ...
  #define Z_SAFE_HOMING   // This feature is meant to avoid Z homing with probe outside the bed area.
    ...
    #define Z_SAFE_HOMING_X_POINT (92)    // X point for Z homing when homing all axis (G28)
    #define Z_SAFE_HOMING_Y_POINT (53)    // Y point for Z homing when homing all axis (G28)
...
// E motor: 
#define DEFAULT_AXIS_STEPS_PER_UNIT   {88.88888888888889,88.88888888888889,400,555}  // default steps per unit for Voxel8 gen3
#define DEFAULT_MAX_FEEDRATE          {500, 500, 4, 600}    // (mm/sec)
