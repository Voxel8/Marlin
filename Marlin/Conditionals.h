 ...
 */
  ...
  #define HAS_PNEUMATIC (PIN_EXISTS(PNEUMATIC))
  #define HAS_PNEUMATIC_PUMP (PIN_EXISTS(PNEUMATIC_PUMP))
  #define HAS_REGULATOR (PIN_EXISTS(REGULATOR))
  ...
  #define HAS_CARTRIDGE_ID (PIN_EXISTS(CART0_SIG2_PIN) || PIN_EXISTS(CART1_SIG2_PIN))
